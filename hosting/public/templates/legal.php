...
<title><?= $DOC['title'] ?> — TS Palletium</title>
...
<main>
  ...
  <section class="page-hero">
    <div class="container">
      <div class="breadcrumb"><a href="index.html"><?= t('k001') ?></a> / <?= $DOC['title'] ?></div>
      <h1><?= $DOC['h1'] ?></h1>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="legal-wrap">
        <p class="legal-meta"><?= $DOC['metaline'] ?></p>
